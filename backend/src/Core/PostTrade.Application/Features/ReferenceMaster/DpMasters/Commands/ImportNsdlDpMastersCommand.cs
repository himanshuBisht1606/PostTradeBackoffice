...
public record ImportNsdlDpMastersCommand(Stream CsvStream) : IRequest<ImportResultDto>;

public class ImportNsdlDpMastersCommandHandler : IRequestHandler<ImportNsdlDpMastersCommand, ImportResultDto>
{
    private readonly IRepository<NsdlDpMaster> _repo;
    private readonly IUnitOfWork _unitOfWork;

    public ImportNsdlDpMastersCommandHandler(IRepository<NsdlDpMaster> repo, IUnitOfWork unitOfWork)
    {
        _repo = repo;
    ...
    public async Task<ImportResultDto> Handle(ImportNsdlDpMastersCommand request, CancellationToken cancellationToken)
    {
        ...
        var toInsert = new List<NsdlDpMaster>();
