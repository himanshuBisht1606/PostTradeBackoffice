...
public class CdslDpMasterConfiguration : IEntityTypeConfiguration<CdslDpMaster>
{
    public void Configure(EntityTypeBuilder<CdslDpMaster> builder)
    {
        builder.ToTable("CdslDpMaster", "reference");
